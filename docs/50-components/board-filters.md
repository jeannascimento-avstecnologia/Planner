...
- **Responsavel**: multi-selecao (membros org + board + "sem responsavel"). Card passa se `assignee_id` ∈ selecao. Mesma fonte de membros do card drawer (`lib/board-assignees.ts`).
