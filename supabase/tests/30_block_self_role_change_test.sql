-- pgTAP: ninguem altera proprio papel org
begin;
...
insert into auth.users (instance_id, id, aud, role, email, created_at, updated_at, raw_app_meta_data, raw_user_meta_data) values
  ...
  ('00000000-0000-0000-0000-000000000000','b2222222-2222-2222-2222-222222222222','authenticated','authenticated','mgr-self@test.dev', now(), now(), '{}'::jsonb, '{}'::jsonb),
...
insert into public.memberships (org_id, user_id, role) values
  ...
  ('e7777777-7777-7777-7777-777777777777','b2222222-2222-2222-2222-222222222222','manager'),
...
select throws_ok(
  $$select public.update_membership_role('e7777777-7777-7777-7777-777777777777', 'b2222222-2222-2222-2222-222222222222', 'admin')$$,
  'P0001',
  'forbidden',
  'viewer bloqueado em alterar outros'
);

-- gerente nao altera a si mesmo
...
select throws_ok(
  ...
  'gerente nao altera proprio papel'
);
